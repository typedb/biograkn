    ...
    for alignment in record.alignments:
        ...
        for hsp in alignment.hsps:
            ...
            q_insert_sequence_for_protein = ('match $pr id ' + protein_id + '; ' +
                                             'insert $seq isa sequence; $seq "' + hsp.sbjct + '"; $pr has sequence $seq;')
            ...
            q_insert_sourcing = ('match $seq isa sequence; $seq "' + hsp.sbjct + '"; ' +
                                 '$db id ' + database_id + '; ' +
            ...
            q_insert_alignment = ('match $target-seq isa sequence; $target-seq "' + target_sequence + '"; ' +
                                  '$matched-seq isa sequence; $matched-seq "' + hsp.sbjct + '"; ' +
